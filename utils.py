...
def download_songs(preview_url, track_id):
    audio_path = "/Users/ytkd/Downloads/downloaded_songs"
    if os.path.exists("/Users/ytkd/Downloads/downloaded_songs") is False:
        os.mkdir("/Users/ytkd/Downloads/downloaded_songs")
    request_count = 0
